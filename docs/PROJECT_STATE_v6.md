...
- **259 passed, 9 skipped.** The 9 are CPLEX-specific machinery (the branch-and-cut callback,
  `CPXPARAM_*` name resolution); no formulation invariant is among them.
...
| **98 tests** / 49 / 169 / 196 / 233 / 248 | **268** (259 passed, 9 skipped) | D67, D68 |
...
Expect **259 passed, 9 skipped** on HiGHS in about 35 seconds; the 9 skips are branch-and-cut
and `CPXPARAM_*` name resolution. On CPLEX, all 268 run.
